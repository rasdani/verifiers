...
train_dataset = load_dataset('rasdani/SkyRL-v0-293-data-oracle-8k-context', split='train').map(lambda x: {'prompt': x['messages'], 'answer': x['patch']})
eval_dataset = load_dataset('rasdani/SkyRL-v0-293-data-oracle-8k-context', split='validation').map(lambda x: {'prompt': x['messages'], 'answer': x['patch']})
